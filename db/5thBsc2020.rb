...
Exam.create(sem: :_fifth, year: "2020", program: "bsc", title: "", uuid: "_fifthbsc2020")

@exam = Exam.find_by(uuid: "_fifthbsc2020")

# Course.create(code:'CSE11',	title:'Computer Interfacing and Microcontroller', credit:3, exam_uuid: "_sixthbsc2018", exam: @exam)
...
Workforce.create(exam_uuid:@exam.uuid, exam:@exam, teacher: Teacher.find_by('fullname LIKE ?', '%Sajed%'), role: "member")
Workforce.create(exam_uuid:@exam.uuid, exam:@exam, teacher: Teacher.find_by('fullname LIKE ?', '%Rokan%'), role: "tabulator")
Workforce.create(exam_uuid:@exam.uuid, exam:@exam, teacher: Teacher.find_by('fullname LIKE ?', '%Sajed%'), role: "tabulator")
Workforce.create(exam_uuid:@exam.uuid, exam:@exam, teacher: Teacher.find_by('fullname LIKE ?', '%Istiak%'), role: "tabulator")
